          ...
          <ol>
            <li>
              <Typography variant="body1">
                <strong>Selecting a Button:</strong> Once you've typed in an ethical question, choose one of the three buttons (For, Against, Neutral) that represents your stance or opinion on the question.
              </Typography>
            </li>
            <li>
              <Typography variant="body1">
